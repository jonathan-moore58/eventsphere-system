    ...
    <div className="relative z-10 max-w-7xl mx-auto space-y-12 pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-px bg-[#27272a] border border-[#27272a]">
        <div className="bg-[#18181b] p-8">
          ...
          <div className="text-5xl font-display-custom font-bold text-[#fafafa]">1,248</div>
        </div>
        <div className="bg-[#18181b] p-8">
          <div className="font-mono-custom text-[10px] text-[#a1a1aa] mb-2 font-bold uppercase tracking-widest">ACTIVE_MANIFESTS</div>
          <div className="text-5xl font-display-custom font-bold text-[#fafafa]">156</div>
        </div>
        <div className="bg-[#18181b] p-8 border-t md:border-t-0 md:border-l border-[#eab308]">
          ...
          <div className="text-5xl font-display-custom font-bold text-[#eab308]">PKR 45.2K</div>
        </div>
